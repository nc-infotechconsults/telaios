...
from telaios.core.types import McpServer, Skill
...
class ToolRegistry:
    ...
    def get(
        ...
        if name in self._factories:
            ...
            if path is None:
                raise KeyError(f"Tool '{name}' requires a workspace_path but none was provided.")
    ...
    def load_skills_from_directory(self, path: str) -> int:
        ...
        """
        from telaios.tools.skill.adapter import manifest_to_executable_tool
