...
import documentFoldersRouter from "./routes/documentFolders.route";
import documentVersionsRouter from "./routes/documentVersions.route";
import documentTagsRouter from "./routes/documentTags.route";
import documentCommentsRouter from "./routes/documentComments.route";
import documentActivitiesRouter from "./routes/documentActivities.route";
import documentTemplatesRouter from "./routes/documentTemplates.route";
import documentProjectTemplatesRouter from "./routes/documentProjectTemplates.route";
import documentFavoritesRouter from "./routes/documentFavorites.route";
import documentCopilotRouter from "./routes/documentCopilot.route";
...
app.use("/projects", documentFoldersRouter);
app.use("/projects", documentVersionsRouter);
app.use("/projects", documentTagsRouter);
app.use("/projects", documentCommentsRouter);
app.use("/projects", documentActivitiesRouter);
app.use("/projects", documentProjectTemplatesRouter);
app.use("/projects", documentFavoritesRouter);
app.use("/projects", documentCopilotRouter);
