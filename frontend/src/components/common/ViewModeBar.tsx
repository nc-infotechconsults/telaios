  ...
  return (
    <div className="flex items-center gap-3 mb-5">
      ...
      <div
        ...
        className="flex items-center rounded-lg border border-divider p-0.5 gap-0.5 bg-content1 shrink-0"
      >
      ...
      <div className="flex items-center gap-1 shrink-0">
        <button
          ...
          className="h-8 w-8 flex items-center justify-center rounded-md border border-divider text-default-400 hover:text-foreground hover:bg-default-100 disabled:opacity-30 disabled:pointer-events-none transition-colors"
        >
