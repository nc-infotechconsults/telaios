...
from api.routers.documents_v2_jobs import (
    run_analysis_job,
    run_convert_job,
    run_extract_job,
    run_summarize_job,
)
from api.routers.documents_v2_models import (
    CompareRequest,
    ConvertRequest,
    ExtractRequest,
    SummarizeRequest,
)
from infra.jobs import get_job_tracker
...
async def analyze_document(document_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        from tools.builtin.documents.analysis import (
            analyze_text,
...
async def extract_structured_data(
    ...
    try:
        from api.routers.documents_v2_llm import extract_structured_from_chunks
        from infra import data_client
...
async def summarize_document(
    ...
    try:
        from api.routers.documents_v2_llm import summarize_chunks
        from infra import data_client
