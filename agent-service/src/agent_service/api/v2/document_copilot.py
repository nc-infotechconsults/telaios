...
Endpoints:
  POST /api/v2/projects/{project_id}/documents/{document_id}/chat

Persistent multi-turn chat backed by AsyncPostgresSaver.
The session is identified by the caller-supplied `session_id`;
the same session_id re-opens the same conversation thread.
"""
