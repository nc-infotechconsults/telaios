...
from telaios.domain.planning.parser import ParsedPlan, parse_plan, parse_planner_response
from telaios.domain.planning.persistence import PlanPersistence
from telaios.domain.planning.prompts import compose_greeting, compose_planning_prompt
...
def parse_plan_from_json(plan_data: dict[str, Any]) -> ParsedPlan:
    ...
    from telaios.domain.planning.parser import parse_plan_from_json as _parse
