...
def _build_llm_config(
    ...
    *settings* is the baseline configuration (typically from the application
    ...
    if raw_key:
        from telaios.utils.crypto import decrypt  # noqa: PLC0415 — deferred
...
def create_agent(config: AgentConfig) -> Agent:
    ...
    """
    from telaios.core.providers import AGENT_REGISTRY  # noqa: PLC0415 — deferred to avoid cycles
...
def create_orchestrator(config: AgentConfig) -> Orchestrator:
    ...
    """
    from telaios.core.providers import ORCHESTRATOR_REGISTRY  # noqa: PLC0415
...
def create_retriever(config: RagConfig, **kwargs: Any) -> Retriever:
    ...
    Raises:
        ValueError: if ``config.framework`` is not registered.
    """
    from telaios.core.providers import RETRIEVER_REGISTRY  # noqa: PLC0415
...
def create_rag(
    ...
    **kwargs: Any,
    ...
    from telaios.core.providers import RAG_REGISTRY  # noqa: PLC0415
